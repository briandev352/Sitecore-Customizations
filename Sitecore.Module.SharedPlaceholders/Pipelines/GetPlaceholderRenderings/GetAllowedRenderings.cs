...
using Sitecore.Module.SharedPlaceholders.Comparers;
using Sitecore.Pipelines.GetPlaceholderRenderings;
using Sitecore.SecurityModel;
using Sitecore.Text;
using Sitecore.Web;

namespace Sitecore.Module.SharedPlaceholders.Pipelines.GetPlaceholderRenderings
{
    /// <summary>
    ...
    public class GetAllowedRenderings
    {
        ...
        public static IEnumerable<PlaceholderDefinition> GetPlaceholderDefinitionList(LayoutDefinition definition, string placeholderKey, ID deviceId)
        {
            ...
            foreach (PlaceholderDefinition placeholderDefinition in placeholders)
            {
                ...
                if (string.Equals(key, lastPart, StringComparison.InvariantCultureIgnoreCase)
                    || string.Equals(key, placeholderKey, StringComparison.InvariantCultureIgnoreCase))
                {
